...
const BasicSettings = () => {
  ...
  const [availabilityDate, setAvailabilityDate] = useState<Date | undefined>(today);
  const [availabilityTime, setAvailabilityTime] = useState<string | undefined>('10:00');
              ...
              <PopoverTrigger asChild>
                <div className="grow relative">
                  ...
                  >
                    <CalendarIcon />
                    {date ? (
                      format(date, 'PPP') + (availabilityTime ? ` - ${availabilityTime}` : '')
                    ) : (
                      ...
                      <ScrollArea className="h-full sm:border-s">
                        <div className="space-y-3">
                          ...
                          <div className="grid gap-1.5 px-5 max-sm:grid-cols-2">
                            {availabilityTimeSlots.map(({ time: timeSlot, available }) => (
                              <Button
                                key={timeSlot}
